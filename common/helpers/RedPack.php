...
class RedPack
{
     ...
     */
    public function __construct($amount, $num = 1, $decimal = 8)
    {
        $this->amount = $amount;
        $this->num = $num;
        $this->decimal = $decimal;

        $this->coupon_min = 1 / pow(10, $this->decimal);
    }
    ...
    protected function apportionRandRatio()
    {
        ...
        return rand(-300, 300) / 100; // 其他情况，上下浮动30%；
    }
    ...
    {
        return sprintf('%01.' . $this->decimal . 'f', round($amount, $this->decimal));
    }
}