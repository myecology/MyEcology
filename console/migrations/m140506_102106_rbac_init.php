...
class m140506_102106_rbac_init extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        //插入数据库
        $this->insert('{{%auth_item}}', ['name' => '/*', 'type' => 2, 'created_at' => time(), 'updated_at' => time()]);
        $this->insert('{{%auth_item}}', ['name' => '所有权限', 'type' => 2, 'created_at' => time(), 'updated_at' => time()]);
        $this->insert('{{%auth_item}}', ['name' => '超级管理员', 'type' => 1, 'created_at' => time(), 'updated_at' => time()]);
        $this->insert('{{%auth_item_child}}', ['parent' => '所有权限', 'child' => '/*']);
        $this->insert('{{%auth_item_child}}', ['parent' => '超级管理员', 'child' => '所有权限']);
        $this->insert('{{%auth_assignment}}', ['item_name' => '超级管理员', 'user_id' => 1, 'created_at' => time()]);
    }
