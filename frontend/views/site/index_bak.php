...
<body>
    ...
    <div class="mask2 ">
        <div class="mask2K paAuto" style="background-image:url('/images/img_1.png');background-size:100% 100%;background-repeat:no-repeat">
            <img src="/images/img_2.png" class="LogoImg" alt="">
            <p>@YOU</p>
            <p>给你发了一个红包</p>
            <p>恭喜发财 大吉大利</p>
            <div class="boxK pa" onclick="runFun()">
                <img src="/images/img_3.png" class="run paAuto" alt="">
                <!-- <img src="/images/img_4.gif" class="run2 paAuto" alt=""> -->
            </div>
        </div>
    </div>
    <div class="mask3 none">
        <img src="/images/img_5.png" class="msT" alt="">
        <div class="kuang">
            <img src="/images/img_2.png" class="logo_2" alt="">
            <div class="zi">@YOU</div>
        </div>
        <div class="jin"><?= $invitePool->prize*$invitePool->prize_registerer/10 ?></div>
        <div class="hint">
            <img src="/images/img_6.png" class="z" alt="">
            <div class="z tishi"><?= $invitePool->symbol ?></div>
            <div class="z hintZ">已放入钱包</div>
        </div>
        <div class="nextBtn" onclick="nextFun()">
            立即领取
        </div>
    </div>
</body>
